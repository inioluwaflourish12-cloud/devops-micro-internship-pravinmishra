...
![alt text](<screenshots/Screenshot 1 (Assignment 4 task1).png>)

---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![alt text](<screenshots/Screenshot 2 (Assignment 4 task1).png>)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![alt text](<screenshots/Screenshot 3 (Assignment 4 task1).png>)
...
![alt text](<screenshots/Screenshot 4 (Assignment 4 task2).png>)

---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![alt text](<screenshots/Screenshot 5 (Assignment 4 task 2).png>)
...
![alt text](<screenshots/Screenshot 6 (Assignment 4 task3).png>)

---

#### Screenshot 7 — Terminal showing a successful SSH login

![alt text](<screenshots/Screenshot 7 (Assignment 4 task3).png>)
...
![alt text](<screenshots/Screenshot 8 (Assignment 4 task4).png>)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![alt text](<screenshots/Screenshot 9(Assignment 4 task4).png>)

---

#### Screenshot 10 — Output of `mysql --version`

![alt text](<screenshots/Screenshot 10 (Assignment 4 task4).png>)
...
![alt text](<screenshots/Screenshot 11 (Assignment 4 task5).png>)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![alt text](<screenshots/Screenshot 12 (Assignment 4 task5).png>)
...
![alt text](<screenshots/Screenshot 13 (Assignment 4 task6).png>)
...
![alt text](<screenshots/Screenshot 14 (Assignment 4 task7).png>)

---

#### Screenshot 15 — Terminal showing the backend running, or `ss -tulpn` showing the port open

![alt text](<screenshots/Screenshot 15 (Assignment 4 task7).png>)

---

#### Screenshot 16 — `curl` output proving the backend responds

![alt text](<screenshots/Screenshot 16 (Assignment 4 task7).png>)
...
![alt text](<screenshots/Screenshot 17 (Assignment 4 task8).png>)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![alt text](<screenshots/Screenshot 18 (Assignment 4 task8).png>)
...
![alt text](<screenshots/Screenshot 19 (Assignment 4 task 9).png>)

---

#### Screenshot 20 — Terminal showing a successful API call through the public endpoint

![alt text](<screenshots/Screenshot 20 (Assignment 4 task9).png>)

---

#### Screenshot 21 — Terminal showing a successful database connectivity test (`SELECT 1;` or similar)

![alt text](<screenshots/Screenshot 21 (Assignment 4 task9).png>)
