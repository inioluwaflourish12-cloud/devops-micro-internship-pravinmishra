...
![alt text](<screenshots/Screenshot 4 (Assignment3 task3).png>)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![alt text](<screenshots/Screenshot 5 (Assignment 3 task3).png>)
...
![alt text](<screenshots/Screenshot 6(Assignment 3 task 4).png>)

---

#### Screenshot 7 — Output of `git commit`

![alt text](<screenshots/Screenshot 7 (Assignment 3 task4).png>)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![alt text](<screenshots/Screenshot 8(Assignment 3 task4).png>)
...
![alt text](<screenshots/Screenshot 9 (Assignment 3 task5).png>)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![alt text](<screenshots/Screenshot 10 (Assignment 3 task5).png>)
...
![alt text](<screenshots/Screenshot 11(Assignment 3 task6).png>)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![alt text](<screenshots/Screenshot 12 (Assignment 3 task6).png>)

---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![alt text](<screenshots/Screenshot 13 (Assignment 3 task6).png>)
...
![alt text](<screenshots/Screenshot 14 (Assignment 3 task 7).png>)
...
![alt text](<screenshots/Screenshot 15 (Assignment 3 task8).png>)
